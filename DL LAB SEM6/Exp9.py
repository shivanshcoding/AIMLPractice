...
class BiLSTM(nn.Module):
    def __init__(self):
        ...
        self.l=nn.LSTM(64,128,batch_first=True,bidirectional=True)
        self.f=nn.Linear(256,2)
    def forward(self,x):
        x=self.e(x)
        o,_=self.l(x)
        return self.f(o[:,-1,:])
...
plt.plot(losses);plt.title("BiLSTM Training Loss");plt.show()
...
print("\nBidirectional LSTM Sentiment Predictions:\n")
